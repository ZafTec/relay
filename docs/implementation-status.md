...
3. Implement PostgreSQL migrations, Better Auth, Google/GitHub login, personal
   ...
   one tested slice -- backend half done (migrations, Better Auth, OAuth
   config, personal workspaces, superadmin, all verified live); the landing
   page and protected `/dashboard` page are still Wave 4C, blocked on the v3
   web foundation (Wave 2C).
